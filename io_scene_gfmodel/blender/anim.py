...
def register() -> None:
    ...
    bpy.types.Scene.gfmodel_sync_preview_range = bpy.props.BoolProperty(
        name='Sync Preview Range',
        default=True,
        description='Sync scene preview range to active action frame range',
    )
